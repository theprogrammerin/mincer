...
getter(module.exports, 'paths', function () {
  return this.__trail__.paths.slice();
});
...
module.exports.prependPath = function (path) {
  this.__trail__.prepend_path(path);
};
...
module.exports.appendPath = function (path) {
  this.__trail__.append_path(path);
};
...
module.exports.clearPaths = function () {
  this.__trail__.paths.forEach(function (path) {
    this.__trail__.remove_path(path);
  }, this);
};
...
getter(module.exports, 'extensions', function () {
  return this.__trail__.extensions.slice();
});
